...
public class OtherReminders extends AppCompatActivity implements ReminderHelperAdapter.OnItemClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.nav_places:
                startActivity(new Intent(OtherReminders.this, MyPlaces.class));
                break;

            case R.id.nav_ads:
                startActivity(new Intent(OtherReminders.this, AllAdvertisements.class));
                break;
            ...
            case R.id.nav_expense:
                startActivity(new Intent(OtherReminders.this, Expenses_Dashboard.class));
                break;

            case R.id.nav_profile:
                startActivity(new Intent(OtherReminders.this, UserProfile.class));
                break;

            case R.id.nav_logout:
                //logout
                FirebaseAuth.getInstance().signOut();
                startActivity(new Intent(OtherReminders.this, Login.class));
                break;
        }
